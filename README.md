...
- `mis/kernel/RecoveryPointObjectiveTestKernel.mis`
...
```bash
bin/misc mis/kernel/RecoveryPointObjectiveTestKernel.mis --check --compact-letters
find mis -name '*.mis' -print0 | xargs -0 -n1 bin/misc --check --compact-letters
```

## Org

[clarity-fintech/recovery-point-objective-test](https://github.com/clarity-fintech/recovery-point-objective-test)
